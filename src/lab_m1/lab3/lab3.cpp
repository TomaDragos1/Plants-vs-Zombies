...
void Lab3::Update(float deltaTimeSeconds)
{
    ...
    //// transform matrix with the matrices you just implemented
    //// Remember, the last matrix in the chain will take effect first!
    //translateX += deltaTimeSeconds * 100.0f;
    //translateY += deltaTimeSeconds * 100.0f;
    ...
    //modelMatrix *= transform2D::Translate(cx, cy);
    //scaleX += deltaTimeSeconds * 0.2f; // Adjust the scale speed
    //scaleY += deltaTimeSeconds * 0.2f;
   ...
   /* modelMatrix = glm::mat3(1);*/
    ...
    //modelMatrix *= transform2D::Translate(100 -450, 100 - 250); // Translate back to i
