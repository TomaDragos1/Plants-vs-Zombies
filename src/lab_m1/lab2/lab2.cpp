...
void Lab2::Init()
{
    ...
    {
         VertexFormat(glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3(1.0f, 0.0f, 0.0f)),   // 0
         VertexFormat(glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3(0.0f, 0.0f, 1.0f)),   // 1
         VertexFormat(glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3(1.0f, 0.0f, 1.0f)),   // 2


         VertexFormat(glm::vec3(-1.0f, -1.0f, 1.0f), glm::vec3(1.0f, 0.0f, 0.0f)), // 3
         VertexFormat(glm::vec3(-1.0f, -1.0f, 1.0f), glm::vec3(1.0f, 0.0f, 1.0f)), // 4
         VertexFormat(glm::vec3(-1.0f, -1.0f, 1.0f), glm::vec3(0.0f, 1.0f, 0.0f)), // 5


         VertexFormat(glm::vec3(1.0f, -1.0f, -1.0f), glm::vec3(1.0f, 0.0f, 0.0f)), // 6
         VertexFormat(glm::vec3(1.0f, -1.0f, -1.0f), glm::vec3(0.0f, 0.0f, 1.0f)), // 7
         VertexFormat(glm::vec3(1.0f, -1.0f, -1.0f), glm::vec3(0.0f, 1.0f, 0.0f)), // 8

         VertexFormat(glm::vec3(-1.0f, 1.0f, -1.0f), glm::vec3(0.0f, 0.0f, 1.0f)),  // 9
         VertexFormat(glm::vec3(-1.0f, 1.0f, -1.0f), glm::vec3(1.0f, 0.0f, 1.0f)),  // 10
         VertexFormat(glm::vec3(-1.0f, 1.0f, -1.0f), glm::vec3(0.0f, 1.0f, 0.0f))  // 11
    };
    ...
    CreateMesh("tethrahedrum", tetrahedronVertices, tetrahedronIndices);

    vector<VertexFormat> squareVertices{
        VertexFormat(glm::vec3(1,0 ,0), glm::vec3(0, 0, 1), glm::vec3(1.0f, 0, 0)),
        VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0, 0, 1), glm::vec3(0, 1.0f, 0)),
        VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 0, 1), glm::vec3(0, 0, 1.0f)),
        VertexFormat(glm::vec3(0, -1, 0), glm::vec3(0, 0, 1), glm::vec3(1.0f, 0, 1.0f)),
    };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tethrahedrum"], shaders["VertexColor"], glm::vec3(7, 0.5f, 0), glm::vec3(0.25f));
