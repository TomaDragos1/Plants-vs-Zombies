    ...
    class Camera
    {
     public:
        ...
        void TranslateRight(float distance)
        {
            ...
            glm::vec3 rightOnGround = glm::normalize(glm::vec3(right.x, 0, right.z));
            position += rightOnGround * distance;
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            right = glm::normalize(glm::cross(forward, glm::vec3(1.0f, 0.0f, 0.0f))); // Assuming Y is up
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // Update forward and right vectors
            forward = glm::normalize(glm::vec3(rotationMatrix * glm::vec4(forward, 0.0f)));
            right = glm::normalize(glm::cross(forward, glm::vec3(0.0f, 1.0f, 0.0f))); // Assuming Y is up
            up = glm::normalize(glm::cross(right, forward));
